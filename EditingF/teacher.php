...
<head>
	...
	?>
				<div id="main_body">
					<div id="myform">
							<ul class="name1">
								<li><h1>Welcome to your Teacher Account page!</h1></li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
							...
							<ul class="name">
								...
								<li>
								<div id="memfeed">Teacher</div>
								</li>
							</ul>
							<ul class="clear"></ul>
							
							<div id="feedback">To change any of your profile information,<br>
							Please, visit the <a href="editteacheracc.php" style="text-decoration: underline; color: rgb(14, 114, 122)">Edit Your Account</a> page.</div>
	...
	?>
		...
		<script type="text/javascript" src="js/viewteacheracc.js"></script>		
	</body>
</html>