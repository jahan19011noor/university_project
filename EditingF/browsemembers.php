<?php
	require_once 'core/init1.php';
			...
			$data1 = $data->get('students', array('id', '>', 0));
?>
				...
				<div id="main_body">
					...
					<div id="posts">
						...
						<div id="datadiv">
							...
							<div id="data">Roll No: <?php echo $datas->roll_no?></div>
							<div id="data">Reg No: <?php echo $datas->reg_no?></div>
							<div id="data">Level: <?php echo $datas->level?></div>
					...
					<?php
						$data2 = $data->get('teachers', array('id', '>', 0));
			
						foreach($data2->results() as $data_names => $datas)
							{
								//foreach($datas as $data_name => $data)
								//{
					?>
					...
					<?php
						$data3 = $data->get('staffs', array('id', '>', 0));
						foreach($data3->results() as $data_names => $datas)
							{
								//foreach($datas as $data_name => $data)
								//{
					?>
