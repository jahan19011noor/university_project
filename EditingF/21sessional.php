...
<head>
				...
				<div id="main_body">
					<div id="myform">
							...
							<ul class="name" id="divc" style="display: none">
								<li><h1></h1></li>
								<li><input type="text" name="last3" id="namexa"/>
							...
							<ul class="name" id="divf" style="display: none">
								<li><h1></h1></li>
								<li><input type="text" name="last6" id="namexb"/>
							...
							<ul class="name" id="divh" style="display: none">
								<li><h1></h1></li>
								<li><input type="text" name="last8" id="namexc"/>
	...
	?>
		...
		<script type="text/javascript" src="js/21sessional.js"></script>
