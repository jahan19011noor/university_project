	...
	?>
				...
				<div id="main_body">
					<!--<form action="register.php" method="POST">-->
						<div id="myform">
							<ul class="name1">
								<li><h1>Welcome, to create a New Teacher Account!</h1></li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
							...
							<ul class="pass" id="radio1">
								<li>
									<input type="radio" class="radio" name="teacher" value="Dean of Faculty">Dean of Faculty
									<input type="radio" class="radio" id="right_radio" name="teacher" value="Head of Department">Head of Department
									<input type="radio" class="radio" id="right_radio" name="teacher" value="Assistant Prof">Assistant Prof
								</li>
							</ul>
							<ul class="pass" id="radio2">
								<li>
