...
<head>
	...
	?>
				<div id="main_body">
					<div id="myform">
							<ul class="name1">
								<li><h1>Welcome to Edit your profile information!</h1></li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
								<li id="image"><img src=""></li>
								<li>
								<div id="imagefeed">Your Profile Image. To change please visit the <a href="imagechange.php">Profile Image Change</a> page</div>
								</li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
							...
							<ul class="pass">
								...
								<li>
								<div id="passfeed">To change, please visite the <a href="changepass.php">Change Password</a> Page.</div>
								</li>
							</ul>
							<ul class="clear"></ul>
