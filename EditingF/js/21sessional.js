$(document).ready(function()
{
	...
	$(':button').click(function()
	{
		...
		var cse_201 = $('[name="last1"]').val();
		var cse_203 = $('[name="last2"]').val();
		var cse_204 = $('[name="last3"]').val();
		var cse_205 = $('[name="last4"]').val();
		var cse_206 = $('[name="last5"]').val();
		var mth_201 = $('[name="last6"]').val();
		var ece_201 = $('[name="last7"]').val();
		var ece_202 = $('[name="last8"]').val();
		...
		{
				$.post('functions/publish21sessional.php',
						{
							full_name : full_name,
							roll_no : roll_no,
							cse_201 : cse_201,
