$(document).ready(function()
{
	...
	$(':button').click(function()
	{
		...
		{
				$.post('functions/publish11sessional.php',
						{
							full_name: full_name,
							roll_no: roll_no,
							session: session,
	...
	function validate_marks7(num1)
	{
		$.post('functions/valid.php', {num1: num1}, function(data)
		{	
			$('#lastfeed1').text(data);
		});
	}
	...
	$('[name="last1"]').focusin(function()
	{
		...
		{
			validate_marks7($('[name="last1"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed1').text('');
	...
	$('[name="last2"]').focusin(function()
	{
		...
		{
			validate_marks6($('[name="last2"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed2').text('');
	...
	$('[name="last3"]').focusin(function()
	{
		...
		{
			validate_marks5($('[name="last3"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed3').text('');
	...
	$('[name="last5"]').focusin(function()
	{
		...
		{
			validate_marks3($('[name="last5"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed5').text('');
	...
	$('[name="last6"]').focusin(function()
	{
		...
		{
			validate_marks2($('[name="last6"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed6').text('');
	...
	$('[name="last7"]').focusin(function()
	{
		...
		{
			validate_marks1($('[name="last7"]').val());
		}
	}).blur(function()
	{
		$('#lastfeed7').text('');
