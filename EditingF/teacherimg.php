...
<head>
	...
	?>
				<div id="main_body">
					<form action="functions/updateteacherimg.php" method="POST" enctype="multipart/form-data">
					<div id="myform">
							<ul class="name1">
								<li><h1>Welcome to Edit your Teacher Account Image!</h1></li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
	...
	?>
		...
		<script type="text/javascript" src="js/teacherimg.js"></script>
	</body>
</html>