						...
						foreach($data1->results() as $data_names => $datas)
							{
								...
								foreach($datas as $data_name => $data)
								{
									...
									(
										...
										$data_name == "cse_101_sessional" ||
										$data_name == "cse_102_sessional" ||
										$data_name == "phy_101_sessional" ||
										$data_name == "mth_101_sessional" ||
										$data_name == "ecn_101_sessional" ||
										$data_name == "hum_101_sessional" ||
										$data_name == "hum_111_sessional"
									)
									{
										?>
										<td>
