...
<head>
	...
	?>
				<div id="main_body">
					<div id="myform">
							<ul class="name1">
								<li><h1>Welcome, to your Student Account page!</h1></li>
							</ul>
							<ul class="clear"></ul>
							<ul class="name">
							...
							Please, visit the <a href="editstudentacc.php" style="text-decoration: underline; color: rgb(14, 114, 122)">Edit Your Account</a> page.</div>
	...
	?>
		...
		<script type="text/javascript" src="js/viewstudentacc.js"></script>		
	</body>
</html>